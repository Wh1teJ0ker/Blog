...
lastmod: '2025-12-09 22:40:16+08:00'
categories:
  - CTF-Writeup
...
![image](assets/image-20251206150727-vm7zyp5.png)
...
![](assets/network-asset-asynccode-20251209221116-z3c5b95.png)
...
![](assets/network-asset-asynccode-20251209221117-ulfdiyo.png)

然后看到这个SecurePassword12

然后挂载

![](assets/network-asset-asynccode-20251209221117-3bmttxl.png)
...
![image](assets/image-20251209221319-c54z0c2.png)

扫码得

![image](assets/image-20251209221519-rcj9twr.png)

PS：被密码手猜出来的，郁郁了🤡

分离压缩包，用上面的密码解密

![image](assets/image-20251209221616-ss3ggts.png)
