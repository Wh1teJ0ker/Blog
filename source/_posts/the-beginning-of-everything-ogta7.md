...
```plain
docker run -d -v /Data/siyuan/workspace:/siyuan/workspace -p 6806:6806 -u 1000:1000 b3log/siyuan --workspace=/siyuan/workspace --restart=always --accessAuthCode=joker 
```
...
​![image](https://raw.githubusercontent.com/Wh1teJ0ker/PicGo/main/Pic/20240726220906.png)​

​![image](https://raw.githubusercontent.com/Wh1teJ0ker/PicGo/main/Pic/20240726220808.png)​

## PicGo

​![image](https://raw.githubusercontent.com/Wh1teJ0ker/PicGo/main/Pic/20240726220907.png)​
...
​![image](https://raw.githubusercontent.com/Wh1teJ0ker/PicGo/main/Pic/20240726220909.png)​

换成自己的访问IP

主要需要完成的设置就是鉴权Token

​![image](https://raw.githubusercontent.com/Wh1teJ0ker/PicGo/main/Pic/20240726220910.png)​
...
```plain
docker run -it --name Blog -p 250:8080 -v "/Data/Blog/coder/.config:/home/coder/.config" -v "/Data/Blog/project:/home/coder/project" -u "$(id -u):$(id -g)" -e "DOCKER_USER=coder" -e PASSWORD='admin' -d codercom/code-server:latest
```
...
​![image](https://raw.githubusercontent.com/Wh1teJ0ker/PicGo/main/Pic/20240726220911.png)​

第二个github.io的仓库Deploy存放github-deploy-key.pub

​![image](https://raw.githubusercontent.com/Wh1teJ0ker/PicGo/main/Pic/20240726220913.png)​
